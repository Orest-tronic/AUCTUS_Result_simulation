// Generated by gencpp from file velocity_qp/PandaRunMsg.msg
// DO NOT EDIT!


#ifndef VELOCITY_QP_MESSAGE_PANDARUNMSG_H
#define VELOCITY_QP_MESSAGE_PANDARUNMSG_H
...
struct PandaRunMsg_
{
  ...
  typedef boost::shared_ptr< ::velocity_qp::PandaRunMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::velocity_qp::PandaRunMsg_<ContainerAllocator> const> ConstPtr;

}; // struct PandaRunMsg_

typedef ::velocity_qp::PandaRunMsg_<std::allocator<void> > PandaRunMsg;

typedef boost::shared_ptr< ::velocity_qp::PandaRunMsg > PandaRunMsgPtr;
typedef boost::shared_ptr< ::velocity_qp::PandaRunMsg const> PandaRunMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::velocity_qp::PandaRunMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::velocity_qp::PandaRunMsg_<ContainerAllocator1> & lhs, const ::velocity_qp::PandaRunMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::velocity_qp::PandaRunMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::velocity_qp::PandaRunMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::velocity_qp::PandaRunMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::velocity_qp::PandaRunMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x978d838c2f0b7635ULL;
  static const uint64_t static_value2 = 0xc26f79d5649e9439ULL;
};

template<class ContainerAllocator>
struct DataType< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::velocity_qp::PandaRunMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::velocity_qp::PandaRunMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // VELOCITY_QP_MESSAGE_PANDARUNMSG_H

...
(cl:defmethod cl:initialize-instance :after ((m <PandaRunMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PandaRunMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name velocity_qp-msg:<PandaRunMsg> is deprecated: use velocity_qp-msg:PandaRunMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:header-val is deprecated.  Use velocity_qp-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'vmax_ec-val :lambda-list '(m))
(cl:defmethod vmax_ec-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:vmax_ec-val is deprecated.  Use velocity_qp-msg:vmax_ec instead.")
  (vmax_ec m))

(cl:ensure-generic-function 't_traj_curr-val :lambda-list '(m))
(cl:defmethod t_traj_curr-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:t_traj_curr-val is deprecated.  Use velocity_qp-msg:t_traj_curr instead.")
  (t_traj_curr m))

(cl:ensure-generic-function 'Xd_traj-val :lambda-list '(m))
(cl:defmethod Xd_traj-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:Xd_traj-val is deprecated.  Use velocity_qp-msg:Xd_traj instead.")
  (Xd_traj m))

(cl:ensure-generic-function 'Xdd_traj-val :lambda-list '(m))
(cl:defmethod Xdd_traj-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:Xdd_traj-val is deprecated.  Use velocity_qp-msg:Xdd_traj instead.")
  (Xdd_traj m))

(cl:ensure-generic-function 'X_err-val :lambda-list '(m))
(cl:defmethod X_err-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:X_err-val is deprecated.  Use velocity_qp-msg:X_err instead.")
  (X_err m))

(cl:ensure-generic-function 'Xd_control-val :lambda-list '(m))
(cl:defmethod Xd_control-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:Xd_control-val is deprecated.  Use velocity_qp-msg:Xd_control instead.")
  (Xd_control m))

(cl:ensure-generic-function 'qd_des-val :lambda-list '(m))
(cl:defmethod qd_des-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:qd_des-val is deprecated.  Use velocity_qp-msg:qd_des instead.")
  (qd_des m))

(cl:ensure-generic-function 'play_traj_-val :lambda-list '(m))
(cl:defmethod play_traj_-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:play_traj_-val is deprecated.  Use velocity_qp-msg:play_traj_ instead.")
  (play_traj_ m))

(cl:ensure-generic-function 'positioning_-val :lambda-list '(m))
(cl:defmethod positioning_-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:positioning_-val is deprecated.  Use velocity_qp-msg:positioning_ instead.")
  (positioning_ m))

(cl:ensure-generic-function 'tune_gains_-val :lambda-list '(m))
(cl:defmethod tune_gains_-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:tune_gains_-val is deprecated.  Use velocity_qp-msg:tune_gains_ instead.")
  (tune_gains_ m))

(cl:ensure-generic-function 'distance_to_contact_-val :lambda-list '(m))
(cl:defmethod distance_to_contact_-val ((m <PandaRunMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader velocity_qp-msg:distance_to_contact_-val is deprecated.  Use velocity_qp-msg:distance_to_contact_ instead.")
